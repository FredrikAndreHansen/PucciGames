...
<head>
	...
	<title>All Game Comments From Banned Users</title>
...
<body>
	...
	<div class="loginspace"></div>
		...
		<div class="adminPage">
			...
			echo "<p style='text-align: center!important;word-break: break-all;' class='darkText'>Game Comments From Banned Users(".$_GET["commentList"]."):</p>";
			
			echo "<form action='" . URLROOT ."/users/admincheckgamecommentsbannedusers' method='GET'>";
			...
			echo "<a href='" . URLROOT . "/users/admincheckgamecomments'><button id='submit'>GO BACK</button></a>";
			...
			if($comments->usertype == "Banned"){
				if($i < $_GET["commentList"]){
					...
					echo "<p style='word-break: break-all;important;font-weight:bold!important;' class='liteText'>" . $game ."</p>";
