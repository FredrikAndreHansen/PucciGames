...
<body>
	...
	<div class="loginspace"></div>
		...
		<div class="adminPage">
			...
			echo "<p style='text-align: center!important;word-break: break-all;' class='darkText'>Post Comments(".$_GET['commentList']."):</p>";
			
			echo "<form action='" . URLROOT ."/users/admincheckpostcomments' method='GET'>";
			...
			echo "<a href='" . URLROOT . "/users/admincheckpostcommentsbannedusers'><button id='logout'>Comments From Banned Users</button></a>";
