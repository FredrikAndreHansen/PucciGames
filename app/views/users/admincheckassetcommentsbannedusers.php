...
<head>
	...
	<title>All Asset Comments From Banned Users</title>
...
<body>
	...
	<div class="loginspace"></div>
		...
		<div class="adminPage">
			...
			echo "<p style='text-align: center!important;word-break: break-all;' class='darkText'>Asset Comments From Banned Users(".$_GET["commentList"]."):</p>";
			
			echo "<form action='" . URLROOT ."/users/admincheckassetcommentsbannedusers' method='GET'>";
			...
			echo "<a href='" . URLROOT . "/users/admincheckassetcomments'><button id='submit'>GO BACK</button></a>";
