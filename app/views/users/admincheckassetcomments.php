...
<head>
	...
	<title>All Asset Comments</title>
...
<body>
	...
	<div class="loginspace"></div>
		...
		<div class="adminPage">
			...
			echo "<p style='text-align: center!important;word-break: break-all;' class='darkText'>Asset Comments(".$_GET['commentList']."):</p>";
			
			echo "<form action='" . URLROOT ."/users/admincheckassetcomments' method='GET'>";
			...
			echo "<a href='" . URLROOT . "/users/admincheckassetcommentsbannedusers'><button id='logout'>Comments From Banned Users</button></a>";
			...
			if($comments->usertype != "Banned"){
				if($i < $_GET["commentList"]){
					...
					echo "<p style='word-break: break-all;color:#8B0000!important;font-weight:bold!important;' class='darkText'>" . $comments->headline ."</p>";
